...
UCLASS()
class VERTEXTERM2_API AlightSwitchBP : public AActor
{
	GENERATED_BODY()
...
public:	
	...
	void OnOverlapBegin_Implementation(class UPrimitiveComponent* OverlappedComp, AActor* OtherActor, UPrimitiveComponent* OtherComp, int32 OtherBodyIndex, bool bFromSweep, const FHitResult& SweepResult);
	...
	void OnOverlapEnd_Implementation(class UPrimitiveComponent* OverlappedComp, AActor* OtherActor, UPrimitiveComponent* OtherComp, int32 OtherBodyIndex);
